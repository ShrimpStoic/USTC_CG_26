...
void Canvas::mouse_click_event()
{
    if (!draw_status_)
    {
        ...
        switch (shape_type_)
        {
            ...
            case USTC_CG::Canvas::kFreehand:
            {
                ...
                freehand->update(start_point_.x, start_point_.y);
    ...
    {
        // For polygon, add new control point on left click
        ...
        {
            // For other shapes, finish drawing
            draw_status_ = false;
            if (current_shape_)
            {
...
{
    // Finish polygon drawing on right-click
